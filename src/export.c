...
const u32 ageRM3Offsets0017[] = {		/* AG_RP_OBJ_EBULLET */
	    384553,    384733,    384921,    385113,    385305,    385497,    385681,    385865,
	    386041,    386229,    386425,    386617,    386805,    387001,    387189,    387377,
	    387561,    387749,    387937,    388129,    388325,    388517,    388705,    388889,
	    389081,    389273,    389457,    389645,    389837,    390025,
};
...
const AGERM3Member ageRM3[] = {
	...
	{     384533,  128,  128,   7680,     30, 2, 0, ageRM3Offsets0017, NULL        },		/* AG_RP_OBJ_EBULLET */
};
