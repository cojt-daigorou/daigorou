...
const AGERomMember ageRM[] = {
	...
	{     389198,          0,  256,  256,  256,  3,     209464, NULL },		/* AG_CG_OBJ_BLOCK */
	{     415381,          0,  256,  256,  256,  3,     141048, NULL },		/* AG_CG_OBJ_BLOCK_H */
};
...
const u32 ageRM3Offsets0016[] = {		/* AG_RP_OBJ_PBULLET */
	    374600,    374924,    375232,    375544,    375856,    376164,    376468,    376788,
	    377096,    377396,    377708,    378016,    378332,    378652,    378968,    379268,
	    379580,    379892,    380216,    380528,    380840,    381148,    381464,    381768,
	    382072,    382388,    382680,    382984,    383288,
};

const u32 ageRM3Offsets0017[] = {		/* AG_RP_OBJ_EBULLET */
	    383613,    383793,    383985,    384185,    384385,    384577,    384765,    384953,
	    385141,    385337,    385533,    385725,    385917,    386117,    386309,    386501,
	    386689,    386881,    387077,    387273,    387473,    387665,    387853,    388037,
	    388237,    388433,    388621,    388813,    389005,
};
...
const AGERM3Member ageRM3[] = {
	...
	{     374580,  128,  128,   7680,     29, 2, 1, ageRM3Offsets0016, NULL        },		/* AG_RP_OBJ_PBULLET */
	{     383593,  128,  128,   7680,     29, 2, 1, ageRM3Offsets0017, NULL        },		/* AG_RP_OBJ_EBULLET */
};
