...
const u32 ageRM3Offsets0016[] = {		/* AG_RP_OBJ_PBULLET */
	    ...
	    382564,    382896,    383220,    383544,    383876,    384208,
};

const u32 ageRM3Offsets0017[] = {		/* AG_RP_OBJ_EBULLET */
	    384553,    384733,    384921,    385113,    385301,    385485,    385677,    385869,
	    386053,    386241,    386433,    386625,    386817,    387005,    387193,    387373,
	    387561,    387749,    387945,    388137,    388329,    388525,    388713,    388889,
	    389073,    389257,    389449,    389641,    389833,    390021,    390204,    390224,
	    390244,    390264,    390284,    390304,    390324,    390344,    390364,    390384,
	    390404,    390424,
};
...
const AGERM3Member ageRM3[] = {
	...
	{     374580,  128,  128,   7680,     30, 2, 0, ageRM3Offsets0016, NULL        },		/* AG_RP_OBJ_PBULLET */
	{     384533,  128,  128,   7680,     42, 2, 0, ageRM3Offsets0017, NULL        },		/* AG_RP_OBJ_EBULLET */
};
