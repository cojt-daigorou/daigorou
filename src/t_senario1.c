...
static struct SPos wpos_1[] = {
  ...
  { 3500+400*2, GROUND_LINE-100*3 , OBJECT_TYPE_HIT_H1, AG_CG_OBJ_LIFT },
  { 3500+400*3, GROUND_LINE-100*4 , OBJECT_TYPE_HIT_H2, AG_CG_OBJ_LIFT },
  { 3500+400*4, GROUND_LINE-100*5 , OBJECT_TYPE_HIT_H1, AG_CG_OBJ_LIFT },
  { 3500+400*5, GROUND_LINE-100*6 , OBJECT_TYPE_HIT,    AG_CG_OBJ_LIFT },
...
static struct SPos ipos_1[] = {
  ...
  { 2300 , GROUND_LINE , ITEM_TYPE_SCORE_A , 0 },
  { 2500 , GROUND_LINE , ITEM_TYPE_STAR , 0 },
  { 2800 , GROUND_LINE , ITEM_TYPE_SCORE_B , 0 },

  { 3500+400*0, GROUND_LINE-100*1, ITEM_TYPE_SCORE_B, 0 },
  { 3500+400*1, GROUND_LINE-100*2, ITEM_TYPE_SCORE_A, 0 },
  { 3500+400*2, GROUND_LINE-100*4, ITEM_TYPE_STAR,    0 },
  { 3500+400*3, GROUND_LINE-100*5, ITEM_TYPE_SCORE_A, 0 },
  { 3500+400*4, GROUND_LINE-100*7, ITEM_TYPE_SCORE_A, 0 },
  { 3500+400*5, GROUND_LINE-100*6, ITEM_TYPE_KEY,     AG_CG_ITEM_MERONPAN64 },
...
static struct SPos wpos_3[] = {
  ...
  { 2800, GROUND_LINE-128*2.4, OBJECT_TYPE_HIT_V1 , AG_CG_OBJ_LIFT },
  ...
  { 2900+128*1, GROUND_LINE-128*1, OBJECT_TYPE_HIT , AG_CG_OBJ_LIFT },
...
static s32 CalcSenario1( struct TaskData* pTask , u32 Flag ) {
  ...
  if( g_Time > 0 && (pTask->x % 60) == 0 ) {
    ...
    if( g_Time == 30 ) {
      ...
      // TODO: AS_SND_BGM_FAST を差し替えるか廃止するかする。
